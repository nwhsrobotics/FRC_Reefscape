...
public class ElevatorSysID extends SubsystemBase {
  private SparkMax elevatorSysIDMotorLeft;
  private RelativeEncoder elevatorSysMotorRightEncoder;
  private final SparkBaseConfig elevatorSysMotorRightConfig;
  private SparkMax elevatorSysIDMotorRight;
  private RelativeEncoder elevatorSysMotorLeftEncoder;
