...
public final class Constants {
    ...
    public static final class LimelightConstants {
        ...
        //Forward Limelight
        public static final double mountHeightForwards = 0.5672; //in meters
        public static final double mountAngleForwards = 24.000; //in degrees with straight being 0 up being 90 and down being -90
